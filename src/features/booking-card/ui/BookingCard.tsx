      ...
      <div className="grid grid-cols-2 items-start gap-4 text-xl">
        {!booking.isPaid && (
          <>
            ...
            <div>
              <span className="flex h-14 items-center">Осталось {`${formatTime(timeLeft)}`}</span>
            </div>
          </>
        )}
      </div>
